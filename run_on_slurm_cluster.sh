...
export NUM_CPUS_PER_TASK=<THE NUMBER OF CPUS AVAILABLE FOR EACH MODEL CONFIG> # or set main argument --num_cpus_per_task
export NUM_GPUS_PER_TASK=<THE NUMBER/PERCENTAGE OF GPUS AVAILABLE FOR EACH MODEL CONFIG> # or set main argument --num_gpus_per_task
...
python3 -u main.py <YOUR ARGUMENTS>
